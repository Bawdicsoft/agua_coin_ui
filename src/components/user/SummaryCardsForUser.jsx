...
//         // const filteredTokenAgua = details.filter(
//         //   (order) => order.TokenType === "AGUA" && order.status === "approved"
//         // );
//         // console.log("filteredTokenAgua", filteredTokenAgua);
//         // const filteredTokenSilver = details.filter(
//         //   (order) => order.TokenType === "AU" && order.status === "approved"
//         // );
//         // console.log("filteredTokenSilver", filteredTokenSilver);
//         // const filteredTokenGold = details.filter(
//         //   (order) => order.TokenType === "AG" && order.status === "approved"
//         // );
//         // console.log("filteredTokenGold", filteredTokenGold);
//         details.forEach((order) => {
//           if (order.status === "approved") {
//             const qty = parseFloat(order.quantity);
//             if (!isNaN(qty)) {
//               totals[order.TokenType] += qty;
//             }
//           }
//         });

//         console.log("Total AGUA:", totals.AGUA);
//         console.log("Total Silver (AU):", totals.AU);
//         console.log("Total Gold (AG):", totals.AG);
//         //
//         //
...
//       balance: loading ? "Loading..." : totals.AG,
//     },
//     {
//       type: "silver",
//       title: "Silver",
...
//       balance: loading ? "Loading..." : totals.AU,
//     },
//     {
//       type: "agua",
//       title: "Agua",
...
//       balance: loading ? "Loading..." : totals.AGUA,
//     },
//   ];
...
//                   ? "Loading..."
//                   : `Current Rate: $${
//                       card.marketRate !== null
//                         ? Number(card.marketRate).toLocaleString(undefined, {
