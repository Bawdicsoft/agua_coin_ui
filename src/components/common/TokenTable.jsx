...
export default function TokenTable({ type }) {
  ...
  return (
    <div className="w-full h-full p-6">
      {/* Header Section */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-2" style={{ color: theme === "dark" ? "var(--color-primary)" : "var(--color-warning)" }}>
                ...
                sortedData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${getStatusColor(item.tokenStatus)}`}>
                        {item.tokenStatus}
                      </span>
                    </td>
